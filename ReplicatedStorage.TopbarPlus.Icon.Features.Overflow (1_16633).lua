-- Name: Overflow
-- Path: game:GetService("ReplicatedStorage").TopbarPlus.Icon.Features.Overflow
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6610605999994732 seconds
...
-- Decompiled on 2026-04-10 16:50:32
-- Luau version 6, Types version 3
-- Time taken: 0.044735 seconds
...
function module_upvr.getWidth(arg1, arg2) -- Line 75
	local TargetWidth = arg1.widget:GetAttribute("TargetWidth")
	if not TargetWidth then
		TargetWidth = arg1.widget.AbsoluteSize
...
function module_upvr.updateBoundary(arg1) -- Line 166
	...
	if var155 then
		...
		if not var152_upvr or not INLINED_9() then
			var157 = var158 + module_upvr.getWidth(var157) + Offset_2_upvr
		end
		local var159 = var157
	end
	local var160_upvw = 0
	...
	if i_5 then
		...
		if var157 and var156 then
			...
			var169 = var156:getInstance("Menu").AbsoluteCanvasSize
			var169 = var169.X
			if var169 > var157.AbsoluteCanvasSize.X then
			else
			end
			var169 = X_2 / 2
