-- Name: Themes
-- Path: game:GetService("ReplicatedStorage").TopbarPlus.Icon.Features.Themes
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.5818593999993027 seconds
...
-- Decompiled on 2026-04-10 16:50:33
-- Luau version 6, Types version 3
-- Time taken: 0.023703 seconds
...
function module_upvr.refresh(arg1, arg2, arg3) -- Line 60
	...
	if arg3 then
		...
		if not any_getThemeValue_result1 then
			any_getThemeValue_result1 = module_upvr
			any_getThemeValue_result1 = any_getThemeValue_result1.getInstanceValue(arg2, arg3)
		end
