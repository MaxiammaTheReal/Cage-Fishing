-- Name: ZoneController
-- Path: game:GetService("ReplicatedStorage").Modules.Zone.ZoneController
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6979817000010371 seconds
...
-- Decompiled on 2026-04-10 16:50:48
-- Luau version 6, Types version 3
-- Time taken: 0.024802 seconds
	...
	if tbl_9_upvr[arg1] then
		...
		tbl_9_upvr[arg1] = Heartbeat_upvr:Connect(function() -- Line 150
			...
			for i_15, v_15 in pairs(tbl_5_upvr[arg1](_currentEnterDetection)) do
				...
				if var124 then
					var124 = module_upvr
					var124 = var124.getGroup(i_15.settingsGroupName)
				end
...
function module_upvr._getZonesAndItems(arg1, arg2, arg3, arg4, arg5) -- Line 293
	...
	local pairs_result1_12, pairs_result2_8, pairs_result3_3 = pairs(arg2)
