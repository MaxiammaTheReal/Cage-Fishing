-- Name: Menu
-- Path: game:GetService("ReplicatedStorage").TopbarPlus.Icon.Elements.Menu
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.5612081999988732 seconds
...
-- Decompiled on 2026-04-10 16:50:26
-- Luau version 6, Types version 3
-- Time taken: 0.009949 seconds
	...
	arg1.menuChildAdded:Connect(function() -- Line 39, Named "totalChildrenChanged"
		...
		if var6_upvw then
			...
			if Themes_upvr.getThemeValue(any_getStateGroup_result1, "IconImage", "Image", "Deselected") == Themes_upvr.getThemeValue(any_getStateGroup_result1, "IconImage", "Image", "Selected") then
				...
				local tbl = {{"IconLabel", "FontFace", Font.new("rbxasset://fonts/families/FredokaOne.json", Enum.FontWeight.Light, Enum.FontStyle.Normal), "Selected"}, {"IconLabel", "Text", 'X', "Selected"}, {"IconLabel", "TextSize", 20, "Selected"}, {"IconLabel", "TextStrokeTransparency", 0.8, "Selected"}, {"IconImage", "Image", "", "Selected"}}
				...
				if not MaxIcons then
					...
					for _, v_3 in pairs_result1_3, pairs_result2_2, pairs_result3_2 do
						if v_3:GetAttribute("WidgetUID") and v_3.Visible then
							table.insert(tbl_2, {v_3, v_3.AbsolutePosition.X})
						end
					end
					pairs_result1_3 = table.sort
					pairs_result1_3(tbl_2, function(arg1_2, arg2) -- Line 137
						local var49
					...
					for i_4 = 1, MaxIcons do
						if not tbl_2[i_4] then break end
						-- KONSTANTERROR: Expression was reused, decompilation is incorrect
						pairs_result1_3 += tbl_2[i_4][1].AbsoluteSize.X + clone_upvr.Padding.Offset
					end
