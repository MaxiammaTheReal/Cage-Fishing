-- Name: Gamepad
-- Path: game:GetService("ReplicatedStorage").TopbarPlus.Icon.Features.Gamepad
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.5569376999992528 seconds
...
-- Decompiled on 2026-04-10 16:50:31
-- Luau version 6, Types version 3
-- Time taken: 0.012622 seconds
	...
	task.delay(var8, function() -- Line 35
		...
		UserInputService_upvr.InputBegan:Connect(function(arg1_2, arg2) -- Line 109
			...
			if arg1_2.UserInputType == Enum.UserInputType.MouseButton1 then
				var28 = GuiService_upvr.SelectedObject
				if var28 then
					var28 = GuiService_upvr.SelectedObject:GetAttribute("CorrespondingIconUID")
				end
				local var30 = var28
				if var30 then
...
function module_upvr.getIconToHighlight() -- Line 136
	...
	if not var38 then
		var38 = var5_upvw
		var38 = var38.lastHighlightedIcon
	end
	if not var38 then
		local var39
