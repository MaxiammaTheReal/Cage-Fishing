-- Name: Dropdown
-- Path: game:GetService("ReplicatedStorage").TopbarPlus.Icon.Elements.Dropdown
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6875111999997898 seconds
...
-- Decompiled on 2026-04-10 16:50:30
-- Luau version 6, Types version 3
-- Time taken: 0.023611 seconds
	...
	local function updateMaxIconsListener_upvr() -- Line 228, Named "updateMaxIconsListener"
		...
		if var83_upvw then
			...
			for i_7 = 1, ceiled do
				...
				local var105
				if not var104 then
					local WidgetUID = var101[1]:GetAttribute("WidgetUID")
					var105 = WidgetUID
					if var105 then
						var105 = iconModule_upvr
						var105 = var105.getIconByUID(WidgetUID)
					end
					if var105 then
						local var107
						if not false then
